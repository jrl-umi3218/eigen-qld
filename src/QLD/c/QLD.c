/* f/QLD.f -- translated by f2c (version 20100827).
	...
	lwar, integer *iwar, integer *liwar)
{
    ...
    static cilist io___24 = { 0, 0, 0, fmt_1500, 0 };
...
/*                  2.11 (Jul, 2005) - error message (LWAR) */
/*                  2.12 (Jul, 2007) - parameter declarations */
/*                  2.13 (Sep, 2007) - test for division by zero */
/*                  2.14 (Feb, 2009) - some if-statements changed */
/*                  2.15 (May, 2009) - comments */
/*                  2.16 (Jun, 2009) - IFAIL=4 introduced */
/*                  2.17 (Apr, 2010) - comments */
